...
module.factory(
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    ...
    */
     ...
     * manipulating `New` instances related to `User`.
     *
     ...
     */
         ...
         * <em>
         * (The remote method definition does not provide any description.
         * This usually means the response is a `New` object.)
         * </em>
         */
        R.news = function() {
          var TargetResource = $injector.get("New");
 ...
 * @ngdoc object
 * @name lbServices.New
 * @header lbServices.New
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `New` model.
 *
 * ## Example
 *
 * See
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.New#create
         * @methodOf lbServices.New
         *
         * @description
         *
         * Create a new instance of the model and persist it into the data source.
        ...
        /**
         * @ngdoc method
         * @name lbServices.New#deleteById
         * @methodOf lbServices.New
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.New#prototype$updateAttributes
         * @methodOf lbServices.New
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.New#updateOrCreate
         * @methodOf lbServices.New
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.New#destroyById
         * @methodOf lbServices.New
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.New#removeById
         * @methodOf lbServices.New
         *
         * @description
         *
    ...
    /**
    * @ngdoc property
    * @name lbServices.New#modelName
    * @propertyOf lbServices.New
    * @description
    * The name of the model represented by this $resource,
    * i.e. `New`.
    */
    R.modelName = "New";
        ...
        R.user = function() {
          var TargetResource = $injector.get("User");
          var action = TargetResource["::get::New::user"];
          return action.apply(R, arguments);
        };
